...
print ("This example code uses an OpenSMOGmod forces from Processing Instructions added to OpenSMOG XML")
#setting MD params
simul_prefix = "Output"
dt = 0.0010             #ps
...
sbm.loadSystemFiles(Grofile=grofile, Topfile=topfile, Xmlfile=xmlfile)
